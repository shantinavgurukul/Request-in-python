...
store = my_response("http://merakilearn.org/api/courses")
# print(store)
...
def my_availableCourse():
    ...
    load_courses = my_response("http://merakilearn.org/api/courses/"+list_id[course_id]+"/exercises")
    ...
    option_type=int(input("enter the option= ppppppppoooooo"))
    store_option=my_data_couses[option_type]["name"] 
    print("store_option", store_option)
    store_slug=my_data_couses[ option_type]["slug"]
    print("store_slug", store_slug)

    childExercises_slug_data=[]
    def parents_slug():
        parents_slug = my_response("http://merakilearn.org/api/courses/"+str(list_id[course_id])+"/exercise/getBySlug?slug="+str(store_slug))
        # parents_slug=requests.get("http://merakilearn.org/api/courses/"+str(list_id[course_id])+"/exercise/getBySlug?slug="+str(store_slug))
        ...
        print(parents_slug["content"], "ppoooonnnnaaammm")
                ...
                if my_data_couses[k]["name"] == store_option :
                    ...
                    for i in (childExercises_slug_data):
                        ...
                        if  i == input_slug:
                            ...
                            child_slug=requests.get("http://merakilearn.org/api/courses/"+str(list_id[course_id])+"/exercise/getBySlug?slug="+input_slug)
